...
@Destination
@Composable
fun MapScreenMain(navigator: DestinationsNavigator? = null,
    ...
    MapScreen(navigator, resultNavigator, previousScreenRoute,latLng, mode, fromAddAddress, true, viewModel)
}